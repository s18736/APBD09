...
namespace LinqConsoleApp
{
    public class LinqSamples
    {
        ...
        public void LoadData()
        {
            ...
            //I wrote these Console.WriteLine in tasks just to have a line on which I can stop during debugging
            Task1();
            Task2();
            Task3();
            Task4();
        ...
        */
        ...
        public void Task8()
        {
            ...
            {
                return emp.Job == "Backend programmer";
            });
        ...
        public void Task11()
        {
            var res = Emps.Aggregate(0,
                (currentMax, value) =>
                {
                    if (currentMax < value.Salary)
                    {
                        return value.Salary;
                    }
                    else
